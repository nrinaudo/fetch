...
object ValueReader {
  ...
  implicit val Language: ValueReader[Language]         = ValueReader(l => fetch.Language.parse(l))
  implicit val Languages: ValueReader[Seq[Language]]   = commaList[Language]
  implicit val Encoding: ValueReader[Encoding]         = ValueReader(e => fetch.Encoding.DefaultEncodings.get(e))
  implicit val Encodings: ValueReader[Seq[Encoding]]   = commaList[Encoding]
  implicit val MediaType: ValueReader[MediaType]       = ValueReader(m => fetch.MediaType.parse(m))
  implicit val MediaTypes: ValueReader[Seq[MediaType]] = parserList(fetch.MediaType.parser)
  implicit val Method: ValueReader[Method]             = ValueReader(m => fetch.Method.parse(m))
  implicit val Methods: ValueReader[Seq[Method]]       = commaList[Method]
  implicit val ETag: ValueReader[ETag]                 = ValueReader(e => fetch.ETag.parse(e))
...
object ValueWriter {
  ...
  implicit val MediaTypes: ValueWriter[Seq[MediaType]] = commaList[MediaType]
